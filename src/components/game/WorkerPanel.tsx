      ...
      {workers.map((worker, i) => {
        ...
        if (isOwned) {
          return (
            ...
            >
              <div 
                className={`p-1.5 relative transition-all ${canAfford ? 'bg-primary/10' : 'bg-muted/30'}`}
              ...
              <div className="flex-1 text-left min-w-0">
                <div className="font-display font-semibold text-[9px] text-foreground truncate tracking-wider">{worker.name}</div>
        ...
        if (isFuture) {
          return (
            ...
            >
              ...
              <div className="flex-1 text-left min-w-0">
                <div className="font-display font-semibold text-[9px] text-muted-foreground/70 tracking-wider">???</div>
