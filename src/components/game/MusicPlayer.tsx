          ...
          >
            ...
            <div className="mt-2 pt-1.5 border-t border-border/30">
              <a href="https://antariksh.me" target="_blank" rel="noopener noreferrer"
                className="block w-full text-center bg-primary/20 border border-primary/50 hover:bg-primary/30 transition-colors px-2 py-1.5 mb-1">
              ...
              <a href="https://linkedin.com/in/aapatre" target="_blank" rel="noopener noreferrer"
                className="block w-full text-center bg-[#0A66C2]/20 border border-[#0A66C2]/50 hover:bg-[#0A66C2]/30 transition-colors px-2 py-1.5">
